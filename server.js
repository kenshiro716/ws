...
// Only require 'express' once and create the app
const app = express();
const PORT = process.env.PORT || 3000; // Let Railway pick the port
...
function requireLogin(req, res, next) {
  const token = req.cookies.token;
   ...
   if (!token) {
    ...
    return res.sendFile(path.join(__dirname, "dashboard", "accessdecline.html"));
  }
...
app.get("/", (req, res) => {
  const filePath = path.join(__dirname, "dashboard", "login.html");
              ...
              <ul>
                  <li>
                      <a href="#">
                          ...
                          <span class="title">imagine gen</span>
                      </a>
                  </li>
...
<div class="floating-heart">
    ...
    <div class="tooltip">Made with ❤️ By imagine</div>
    </div>
...
<div class="floating-heart">
    <i class="fas fa-heart"></i>
    <div class="tooltip">Made with ❤️ imagine</div>
    </div>
